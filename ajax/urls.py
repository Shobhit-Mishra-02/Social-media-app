...
urlpatterns = [
    ...
    path("addGeneralInformation/", views.add_general_information,
         name="general_information"),
    path("generalInformation/<int:id>/", views.get_general_information,
         name="get_general_information"),
    path("getPersonalInformation/<int:id>/",
         views.get_personal_information, name="get_personal_information"),
    path("addPersonalInformation/", views.add_personal_information,
