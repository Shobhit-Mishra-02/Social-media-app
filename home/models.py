...
class PersonalInformation(models.Model):
    ...
    occupation = models.CharField(_("Occupation of user"), max_length=300, blank=True)
    status = models.CharField(_("Current status of user"), max_length=600, blank=True)
    location = models.CharField(_("location of user"), max_length=600, blank=True)
    home_address = models.TextField(_("Complete home address of user"), blank=True)
    phone_number = models.CharField(_("Phone number of user"), max_length=10, blank=True)
